            ...
            <ul class="row">
                ...
                <li class="cell">
                    ...
                    <div class="relative">
                        <div>
                            <ul>
                                <li><a class="block" href="https://map.naver.com/v5/entry/place/1032743543?c=14184785.3813256,4349329.0132928,17,0,0,0,dh&placePath=%2Fhome%3Fentry=plt" target="_blank">오시는길</a></li>
                                <li><a class="block" href="https://search.naver.com/search.naver?where=nexearch&sm=tab_etc&pkid=632&os=16234600&qvt=0&query=Justin%20Hurwitz%20Classic%20RopeADope" target="_blank">이달의 매장음악</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
